...
int main(int argc, char** argv) {
    ...
    return (reduce_conservatively) ? apply_pass(argv[1], &pass_replace_mux_selectors_individual, -1, irg_ident) : apply_pass(import_file, &pass_replace_mux_selectors, irg_nr, NULL);
}