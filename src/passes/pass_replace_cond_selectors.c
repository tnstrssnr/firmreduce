...
int main(int argc, char** argv) {
    ...
    return (reduce_conservatively) ? apply_pass(import_file, &pass_replace_cond_selectors_individual, -1, irg_ident) : apply_pass(import_file, &pass_replace_cond_selectors, irg_nr, NULL);
}
