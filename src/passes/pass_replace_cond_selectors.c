...
int main(int argc, char** argv) {
    ...
    return (reduce_conservatively) ? apply_pass(import_file, &pass_replace_cond_selectors_individual, irg_ident) : apply_pass(import_file, &pass_replace_cond_selectors, irg_ident);
}
