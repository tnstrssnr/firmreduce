...
int main(int argc, char** argv) {
    return (atoi(argv[3]) == 1) ? apply_pass(argv[1], &pass_replace_switch_selectors_individual, -1, argv[4]) : apply_pass(argv[1], &pass_replace_switch_selectors, atoi(argv[2]), NULL);
}